...
public abstract class BeaconDistanceCalculator {
   ...
   public static final int CALIBRATED_RSSI_AT_ONE_METER = -59;  //yskim hycon
    ...
    public static float calculateDistanceTo(Beacon beacon, float rssi) {
        ...
        float value=calculateDistance(rssi, beacon.getCalibratedRssi(), beacon.getCalibratedDistance(), pathLossParameter);
        System.out.print("yskim calculateDistanceTo = "+((IBeacon) beacon).getMinor()+"  "+rssi+"   "+value+"\n");
